...
// Доп:
// Создать класс для хранения данных библиотеки.
// Книга: название, автор, год издания.
// Реализовать методы добавления книги, получения книги по названию, получения книг
// после заданного года.
// Реализовать методы сохранения и загрузки библиотеки в текстовый файл
